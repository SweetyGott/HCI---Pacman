...
/* *************************************
	*  DEFAULT VALUES FOR THE fours GHOSTS
*/
...
var GHOST_BLINKY_POSITION_X_DEFAULT = null;
if ( NUM_PLAYER == 4 ) {
	GHOST_BLINKY_POSITION_X_DEFAULT = 276;
} else {
	GHOST_BLINKY_POSITION_X_DEFAULT = -276;
}
...
var GHOST_PINKY_POSITION_X_DEFAULT = null;
if ( NUM_PLAYER >= 1 ) {
	GHOST_PINKY_POSITION_X_DEFAULT = 276;
} else {
	 GHOST_PINKY_POSITION_X_DEFAULT = -276;
}
...
var GHOST_INKY_POSITION_X_DEFAULT = null;
if ( NUM_PLAYER >= 2 ) {
	GHOST_INKY_POSITION_X_DEFAULT = 238;
} else {
	 GHOST_INKY_POSITION_X_DEFAULT = -238
}
...
var GHOST_CLYDE_POSITION_X_DEFAUL = null;
if ( NUM_PLAYER >= 3 ) {
	GHOST_CLYDE_POSITION_X_DEFAULT = 314;
} else {
	 GHOST_CLYDE_POSITION_X_DEFAULT = -314;
}
...
//BEHAVIOUR
var GHOST_MOVING_TIMER = -1;
var GHOST_MOVING = false;
var GHOST_STATE = 0;//0 ist normal others are somehow afraid
var GHOST_EAT_TIMER = null;
var GHOST_AFFRAID_TIMER = null;
var GHOST_AFFRAID_STATE = 0;
var GHOST_TUNNEL = false;
...
var GHOST_BLINKY_MOVING_TIMER = GHOST_MOVING_TIMER;
var GHOST_BLINKY_MOVING = GHOST_MOVING;
var GHOST_BLINKY_BODY_STATE = 0;
var GHOST_BLINKY_STATE = GHOST_STATE;
var GHOST_BLINKY_EAT_TIMER = GHOST_EAT_TIMER;
var GHOST_BLINKY_AFFRAID_TIMER = GHOST_AFFRAID_TIMER;
var GHOST_BLINKY_AFFRAID_STATE = GHOST_AFFRAID_STATE;
var GHOST_BLINKY_TUNNEL = GHOST_TUNNEL;
...
var GHOST_PINKY_MOVING_TIMER = GHOST_MOVING_TIMER;
var GHOST_PINKY_MOVING = GHOST_MOVING;
var GHOST_PINKY_BODY_STATE = 1;
var GHOST_PINKY_STATE = GHOST_STATE;
var GHOST_PINKY_EAT_TIMER = GHOST_EAT_TIMER;
var GHOST_PINKY_AFFRAID_TIMER = GHOST_AFFRAID_TIMER;
var GHOST_PINKY_AFFRAID_STATE = GHOST_AFFRAID_STATE;
var GHOST_PINKY_TUNNEL = GHOST_TUNNEL;
...
var GHOST_INKY_MOVING_TIMER = GHOST_MOVING_TIMER;
var GHOST_INKY_MOVING = GHOST_MOVING;
var GHOST_INKY_BODY_STATE = 2;
var GHOST_INKY_STATE = GHOST_STATE;
var GHOST_INKY_EAT_TIMER = GHOST_EAT_TIMER;
var GHOST_INKY_AFFRAID_TIMER = GHOST_AFFRAID_TIMER;
var GHOST_INKY_AFFRAID_STATE = GHOST_AFFRAID_STATE;
var GHOST_INKY_TUNNEL = GHOST_TUNNEL;
...
var GHOST_CLYDE_MOVING_TIMER = GHOST_MOVING_TIMER;
var GHOST_CLYDE_MOVING = GHOST_MOVING;
var GHOST_CLYDE_BODY_STATE = 3;
var GHOST_CLYDE_STATE = GHOST_STATE;
var GHOST_CLYDE_EAT_TIMER = GHOST_EAT_TIMER;
var GHOST_CLYDE_AFFRAID_TIMER = GHOST_AFFRAID_TIMER;
var GHOST_CLYDE_AFFRAID_STATE = GHOST_AFFRAID_STATE;
var GHOST_CLYDE_TUNNEL = GHOST_TUNNEL;
